...
(async function () { // Enables async/await in JS [part 1]
  ...
  const stringGlobalSignal1 = await State.createGlobalStringSignal(INITAL_VALUE(1), 'stringSignal1');
  const stringGlobalSignal2 = await State.createGlobalStringSignal(INITAL_VALUE(2), 'stringSignal2');
